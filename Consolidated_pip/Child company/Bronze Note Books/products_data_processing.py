...
delta_table = DeltaTable.forName(spark, "product.gold.dim_products")
df_child_products = spark.sql(f"SELECT product_code, division, category, product, variant FROM product.gold.sb_dim_products;")
